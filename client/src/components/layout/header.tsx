...
export default function Header() {
  ...
  // Добавить проверку, является ли пользователь админом или модератором
          ...
          <nav className="hidden md:flex space-x-6">
            {user && (
              <>
                ...
                {/* Добавить ссылку на админ-панель только для админов и модераторов */}
                {isAdminOrModerator && (
                  <Link
                    href="/admin"
                    className="nav-link text-gray-300 font-medium hover:text-white"
                  >
                    {t("adminPanel")}
                  </Link>
                )}
          ...
          >
            {user ? (
              <>
                ...
                {/* Добавить ссылку на админ-панель только для админов и модераторов в мобильном меню */}
                {isAdminOrModerator && (
                  <Link
                    href="/admin"
                    className="text-gray-300 hover:text-white"
